...
<body>
	<page size='A4'>
		<div style="padding: 5px;  padding-left:20px; padding-right:20px; " contenteditable="true">
			...
			<h4 style="text-align: center;">Items Return to Supplier ( Date: <?php echo date("d F, Y ", time()) ?>)</h4>
			<hr />
			<br />
			<table>
				<tr>
				...
				<tr>
					<th>Return Receipt No:</th>
					<td><?php echo $suppliers_invoices->supplier_invoice_number; ?></td>
				</tr>

				<tr>
					<th>Receipt Dated:</th>
					<td><?php echo date("d F, Y ", strtotime($suppliers_invoices->invoice_date))  ?></td>
				</tr>
