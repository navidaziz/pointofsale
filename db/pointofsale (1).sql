...
(100, '03244424414', 'Navid Aziz', 2116, 20, 2096, 0, 2096, 96, 2000, 2000, 0, 'cash', '', 1, NULL, 1, '2021-04-11 17:32:04', NULL, NULL, NULL),
(101, 'fasdfa', 'sdfasdfa', 240, 30, 210, 0, 210, 10, 200, 200, 0, 'cash', '', 1, NULL, 1, '2021-04-11 17:36:37', NULL, NULL, NULL),
(102, '', '', 120, 20, 100, 0, 100, 0, 100, 100, 0, 'cash', '', 1, NULL, 1, '2021-04-11 17:37:33', NULL, NULL, NULL);
...
INSERT INTO `sales_items` (`sale_item_id`, `sale_id`, `item_id`, `item_name`, `cost_price`, `unit_price`, `item_discount`, `quantity`, `sale_price`, `total_price`, `returned`, `remarks`, `created_by`, `created_date`) VALUES
(352, 100, 16, 'birmogh', 100, 120, 20, 1, 100, 100, 0, NULL, 1, '2021-04-11 22:32:04'),
(353, 100, 17, 'dsfasdf', 23, 23, 0, 2, 23, 46, 0, NULL, 1, '2021-04-11 22:32:04'),
(354, 100, 19, 'nokia', 1000, 1500, 0, 1, 1500, 1500, 0, NULL, 1, '2021-04-11 22:32:04'),
(355, 100, 18, 'item 2', 100, 150, 0, 3, 150, 450, 0, NULL, 1, '2021-04-11 22:32:04'),
(356, 101, 16, 'birmogh', 100, 120, 20, 1, 100, 100, 0, NULL, 1, '2021-04-11 22:36:37'),
(357, 101, 15, 'chambor', 100, 120, 10, 1, 110, 110, 0, NULL, 1, '2021-04-11 22:36:37'),
(358, 102, 16, 'birmogh', 100, 120, 20, 1, 100, 100, 0, NULL, 1, '2021-04-11 22:37:33');
...
INSERT INTO `sale_taxes` (`sale_tax_id`, `sale_id`, `tax_id`, `tax_name`, `tax_percentage`) VALUES
(60, 100, 1, 'Sales Tax', 0),
(61, 101, 1, 'Sales Tax', 0),
(62, 102, 1, 'Sales Tax', 0);
...
(1, 'Application Title', 'Application Detail', 'system_global_settings/6eea04a9166ec931e88b089727c4bca8.jpg', 'system_global_settings/7867ebb44e353b489aee7d60885b4c37.jpg', '0000 0000000', '0000 0000000', '0000 0000000', '0000 0000000', 'Address ', 'http://www.abc.com', 'some detail', '9', '2', 1, 1, 0, '2015-07-28 09:08:27', NULL);
...
--
ALTER TABLE `sales`
  MODIFY `sale_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT for table `sales_items`
--
ALTER TABLE `sales_items`
  MODIFY `sale_item_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=359;
...
--
ALTER TABLE `sale_taxes`
  MODIFY `sale_tax_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
